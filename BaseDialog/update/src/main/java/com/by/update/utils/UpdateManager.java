...
import com.by.update.downloadmanager.DownloadHandler;
import com.by.update.downloadmanager.DownloadObserver;
import com.by.update.entity.AppUpdate;
import com.by.update.listener.UpdateDialogListener;
import com.by.update.view.UpgradeDialog;
...
public class UpdateManager implements UpdateDialogListener {
    ...
    public void startUpdate(Context context, AppUpdate appUpdate, DialogDismissCallBack dialogDismissCallBack) {
        ...
        upgradeDialog.show( "UpdateManager");
    }
